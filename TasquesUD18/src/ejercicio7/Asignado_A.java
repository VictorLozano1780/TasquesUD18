...
public class Asignado_A {
	...
	public static void createTable(String db, String name) {
		try {
			...
			String Query = "CREATE TABLE " + name + "" + "" + "(Cientifico varchar(8), Proyecto varchar(4), "
	...
	public static void insertData(String db, String table_name, String cientifico, String proyecto) {
		try {
			String Querydb = "USE " + db + ";";
			Statement stdb = ConnectDB.conexion.createStatement();
			stdb.executeUpdate(Querydb);
